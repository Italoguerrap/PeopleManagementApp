...
export function EditModal({ user, onClose, onUserUpdated }) {
  ...
  const [birthDate, setBirthDate] = useState(user?.dateOfBirth ? user.dateOfBirth.slice(0, 10) : '');
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      let genderValue = GenderType.Other;
      if (sex === "Masculino") {
      ...
      const personData = {
        ...
        country: nationality,
        cpf
      };      const updatedUser = await updatePerson(user.id, personData);
  ...
  return (
    <ModalOverlay onClick={onClose}>
      <ModalContent onClick={e => e.stopPropagation()}>
        <h2>
          <FaUserEdit style={{ marginRight: '10px', verticalAlign: 'middle' }} />
          Editar Usuário
        </h2>
        <ToastContainer />
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            />
            {errors.cpf && <div className="error-message">
              <FaTimes size={12} />
              {errors.cpf}
            </div>}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.sex && <div className="error-message">
              <FaTimes size={12} />
              {errors.sex}
            </div>}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.birthDate && <div className="error-message">
              <FaTimes size={12} />
              {errors.birthDate}
            </div>}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.naturality && <div className="error-message">
              <FaTimes size={12} />
              {errors.naturality}
            </div>}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.nationality && <div className="error-message">
              <FaTimes size={12} />
              {errors.nationality}
            </div>}
          </div>
